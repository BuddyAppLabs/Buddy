...
<template>
  <div class="h-full overflow-y-auto p-6">
    <div class="max-w-4xl mx-auto">
      ...
      <!-- 加载状态 -->
      <div v-if="isLoading && providers.length === 0" class="flex justify-center py-12">
          ...
          <div class="card-body">
            ...
            <div class="card-actions justify-end mt-4">
              <button
                ...
                :disabled="!provider.apiKey || !String(provider.apiKey).trim() || isSaving || isLoading"
              >
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  viewBox="0 0 24 24"
              ...
              <button
                ...
                :disabled="!provider.apiKey || !String(provider.apiKey).trim() || isSaving"
              >
