...
export class MarketManager implements MarketContract {
    /**
     * 构造函数
     ...
     */
    constructor(
        private readonly repository: MarketRepositoryContract,
        private readonly downloader: MarketDownloaderContract
    ) { }

    /**
     * 获取插件仓储
     */
    public getRepository(): MarketRepositoryContract {
     ...
     * 获取下载器
     */
    public getDownloader(): MarketDownloaderContract {
