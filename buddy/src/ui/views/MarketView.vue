...
<template>
    <div class="p-4 h-full flex flex-col">
            ...
            <ToolBar variant="compact" :bordered="false">
                <template #left>
                    <div role="tablist" class="tabs tabs-box bg-primary/50 shadow-inner">
                        ...
                        <a role="tab" class="tab" :class="{ 'tab-active': marketStore.activeTab === 'devRepo' }"
                            v-if="isDev" @click="switchTab('devRepo')">
                            开发仓库
                        </a>
                        <a role="tab" class="tab" :class="{ 'tab-active': marketStore.activeTab === 'devPackage' }"
                            v-if="isDev" @click="switchTab('devPackage')">
                            开发包
                        </a>
                    </div>
                </template>
                ...
                <template #right>
                    <ButtonFolder v-if="marketStore.activeTab === 'user' || marketStore.activeTab === 'devRepo'"
        ...
        <DevRepoList :plugins="devPlugins" v-if="marketStore.activeTab === 'devRepo'" />
