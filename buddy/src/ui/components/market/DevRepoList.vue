...
const { disableDevRepo, enableDevRepo, resetDevPluginDir, setDevPluginDir, devPlugins } = usePluginRepo()
</script>
...
<template>
    ...
    <div class="mb-4 w-full">
        <div
            ...
            <span>当前开发仓库目录: <code>{{ marketStore.devPluginDirectory }}</code></span>
            <div class="flex flex-row gap-2">
                ...
                <button class="btn btn-xs btn-outline" @click="disableDevRepo">禁用</button>
                <button class="btn btn-xs btn-outline" @click="enableDevRepo">启用</button>
            </div>
        </div>
    </div>
