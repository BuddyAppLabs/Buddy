...
<template>
  <transition
    ...
    <div
      class="p-4 rounded-lg shadow-md hover:shadow-lg transition-all duration-300"
      :class="cardClass">
      <!-- 插件详细信息 -->
      <div
        class="flex justify-between items-center text-sm border-b border-secondary/20 mb-2">
