...
<template>
  ...
  <Transition name="alert-fade">
    <div v-if="globalAlert.state.value.show" :class="[alertContainerClass, alertPositionClass]">
      <Alert :type="globalAlert.state.value.type" :message="globalAlert.state.value.message"
        :closable="globalAlert.state.value.closable" :position="globalAlert.state.value.position"
